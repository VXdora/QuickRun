...
# }
#
# function setExtraOption() {
#   reset
#   while true; do
#
#     # print usage
#     echo "input extra option:"
#     echo "[1]: Environment Value"
#     echo "[2]: Install Extend Package"
#     echo "[3]: Set EntryPoint"
#     echo "[4]: Set AWS Profile"
#     echo "[5]: Set Outbound Port"
#     echo "[9]: Exit"
#
#     # get & validate option value
#     read OPT
#     if [[ ! $OPT =~ ^[0-9]$ ]]; then
#       echo "Invalid Parameter was detected!"
#       continue
#     fi
#
#     # select option
...
if [ $1 = 'init' ]; then
  ...
  #
  # # get package manager info (ex. apt or dnf)
  # echo "    \"pcman\": \"$(cat $QRUN_IMSET/$BSIMG_N/pkgman.conf)\"," >> $PROJECT_QUICKRUN
  # # select tag of image
  ...
  #
  # # set aws key if need
  # echo "input AWS profile (if you use no profile, input EMPTY value): "
  # read AWSPROFILE
